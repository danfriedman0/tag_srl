...
# Taken from Luheng He, https://github.com/luheng/deep_srl
import numpy
...
def block_orth_normal_initializer(input_shapes,
                                  output_shapes,
                                  factor=1.0,
                                  seed=None):
    ''' Initialize a gigantic weight matrix where each block
    is a normal orthogonal matrix.
    Input:
    ...
    def _initializer(shape, dtype, partition_info=None):
        ...
        params = numpy.concatenate(
            [numpy.concatenate([initializer([dim_in, dim_out], dtype)
